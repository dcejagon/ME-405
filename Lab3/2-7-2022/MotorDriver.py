...
class MotorDriver:
    ...
    def __init__ (self,en_pin,in1pin,in2pin,timer,duty1,duty2):
        '''!
    ...
    def set_duty_cycle (self,duty1,duty2):
        '''
        ...
        if self.duty1.read()>=0:
            
            self.ch1.pulse_width_percent(self.duty1.read())
            self.ch2.pulse_width_percent(0)
        else:
            self.ch1.pulse_width_percent(0)
            self.ch2.pulse_width_percent(abs(self.duty1.read()))
            
        if self.duty2.read()>=0:
            
            self.ch1.pulse_width_percent(self.duty2.read())
            self.ch2.pulse_width_percent(0)
        else:
            self.ch1.pulse_width_percent(0)
            self.ch2.pulse_width_percent(abs(self.duty2.read()))
