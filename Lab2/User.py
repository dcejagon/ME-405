...
class User:
    ...
    def __init__(self, Kp, setpoint):
        ...
        '''             @brief              Constructs an encoder task object
                        ...
                        @param Kp           The share used to communicate action requests to the encoder task
                        @param setpoint     The share used to communicate the duty level requested to the motor task
                       
        '''
        ## @brief   Variable for the action share
        #  @details Initializes the action share and allo   ws for the share to be used within this task.
        #
        self.Kp = Kp
